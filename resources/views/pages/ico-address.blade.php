                        ...
                        <div class="col-xs-12 col-md-10 col-md-offset-1 eth-address">
                            ...
                            <div class="bonuses-modal">
                                <div class="" data-toggle="modal" data-target="#Gas1Modal">
                                    <p><span class="announcement"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> To make smooth & fast transaction without rejection, set GAS LIMIT to <b>200,000</b> and gas price to <b>120 GWEI</b> or more.</span></p>
                                </div>
