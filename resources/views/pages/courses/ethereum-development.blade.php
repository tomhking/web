...
@section('steps')
    <ul class="nav ">
        ...
        <li><a class="list-group-item" href="">2. Blockchain, Ethereum & Smart Contract</a></li>
        ...
        <li><a class="list-group-item" href="">8. Build an ICO crowdsale with Open Zeppelin</a></li>
    </ul>
@endsection