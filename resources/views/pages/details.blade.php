                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input tabindex="4" type="date" class="form-control" id="input-birthday" value="{{ old('birthday', $user->birthday instanceof \Carbon\Carbon ? $user->birthday->format('Y-m-d') : null) }}" name="birthday" max="{{ \Carbon\Carbon::today()->subYears(16)->toDateString() }}" min="{{ \Carbon\Carbon::today()->subYears(100)->toDateString() }}" required>
                                        </div>
                                        <div class="form-group">
