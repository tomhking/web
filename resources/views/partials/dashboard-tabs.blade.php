<div class="dashboard-navigation">
    <ul class="nav nav-tabs">
        <li class="active"><a href="{{ route('address') }}">Crowdsale</a></li>
        <li><a href="{{ route('participate') }}"><i class="fa fa-question-circle" aria-hidden="true"></i> How to participate</a></li>
