<div class="dashboard-navigation">
    <ul class="nav nav-tabs">
        @if(config('ico.started'))
            <li class="{{ current_route_class('address') }}"><a href="{{ route('address') }}"><img class="token" src="{{ asset_rev('token-img.png') }}" alt="BitDegree Token"> Crowdsale</a></li>
        @endif
        ...
        @if(auth()->user()->isAirdropParticipant())
            <li class="{{ current_route_class('user') }}"><a href="{{ route('user') }}"><i class="fa fa-plane" aria-hidden="true"></i> My Airdrops</a></li>
        @endif
    </ul>
</div>