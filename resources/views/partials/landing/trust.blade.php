        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="row row-logos">
                    ...
                    <div class="col-xs-6 col-sm-3 text-center">
                        <a href="https://cointelegraph.com/press-releases/ea-co-founder-jeff-burton-to-advise-bitdegree-on-a-course-to-revolutionize-education-with-blockchain" rel="nofollow" target="_blank"><img src="{{ asset('trust-logos/cointelegraph2.png') }}" alt="As seen on Cointelegraph"></a>
                    </div>
                    <div class="col-xs-6 col-sm-3 text-center">
                        <a href="https://thenextweb.com/guests/employer-demanded-skills-school-grad-skills-huge-gap/#.tnw_VDEPyYzB" rel="nofollow" target="_blank"><img src="{{ asset('trust-logos/tnw.png') }}" alt="As seen on The Next Web"></a>
                    </div>
                    <div class="col-xs-6 col-sm-3 text-center">
                        <a href="http://www.huffingtonpost.com/entry/the-future-of-degree_us_59c165a7e4b082fd4205ba50" rel="nofollow" target="_blank"><img src="{{ asset('trust-logos/huffpost.png') }}" alt="As seen on Huffpost"></a>
                    </div>
                ...
                <div class="row row-logos">
                    ...
                    <div class="col-xs-6 col-sm-3 text-center">
                        <a href="https://news.bitcoin.com/pr-ea-co-founder-jeff-burton-to-advise-bitdegree-on-a-course-to-revolutionize-education-with-blockchain/" rel="nofollow" target="_blank"><img src="{{ asset('trust-logos/bitcoin-news.png') }}" alt="As seen on Bitcoin News"></a>
                    </div>
                    <div class="col-xs-6 col-sm-3 text-center">
                        <a href="https://www.cryptocoinsnews.com/bitdegree-challenges-coursera-hackerranks-phenomenon-gearing-blockchain/" rel="nofollow" target="_blank"><img src="{{ asset('trust-logos/cryptocoins.png') }}" alt="As seen on Cryptocoins News"></a>
                    </div>
                </div>
                <div class="row row-logos">
                    <div class="col-xs-6 col-sm-3 text-center">
                    ...
                    <div class="col-xs-6 col-sm-3 text-center">
                        <a href="https://www.thestreet.com/story/14325627/1/bitdegree-challenges-coursera-and-hackerranks-phenomenon-by-gearing-up-with-blockchain.html" rel="nofollow" target="_blank"><img src="{{ asset('trust-logos/thestreet.png') }}" alt="As seen on The Street"></a>
                    </div>
                </div>
                <div class="row row-logos">
                    <div class="col-xs-6 col-sm-3 text-center">
                        <a href="https://seekingalpha.com/pr/16955692-bitdegree-challenges-coursera-hackerranks-phenomenon-gearing-blockchain" rel="nofollow" target="_blank"><img src="{{ asset('trust-logos/seeking-alpha.png') }}" alt="As seen on Seeking Alpha"></a>
                    </div>
                    <div class="col-xs-6 col-sm-3 text-center">
                    ...
                    <div class="col-xs-6 col-sm-3 text-center">
                        <a href="https://e27.co/blockchain-tech-will-disrupt-education-ways-expect-20170927/" rel="nofollow" target="_blank"><img src="{{ asset('trust-logos/e27.png') }}" alt="As seen on e27"></a>
                    </div>
                </div>
                <div class="row row-logos">
                    <div class="col-xs-6 col-sm-3 text-center">
                        <a href="https://bitcoinexchangeguide.com/bitdegree/" rel="nofollow" target="_blank"><img src="{{ asset('trust-logos/bitcoinexchangeguide.png') }}" alt="As seen on Bitcoin Exchange Guide"></a>
                    </div>
                    <div class="col-xs-6 col-sm-3 text-center">
