                                    ...
                                    @else
                                        ...
                                        <div class="progress-bar-wrapper">
                                            ...
                                            @else
                                                ...
                                                <!-- hard cap marker -->
                                                <div class="hard-cap-marker"  style="z-index: 20; position: absolute; top: 0; bottom:0; width: 1px; height: 30px; right: 0; background: #fff;"> <h5 class="hard-cap-text">@lang('ico.hard-cap')</h5></div>
                                            @endif
                                        </div>
