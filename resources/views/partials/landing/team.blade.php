                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="team-member">
                        ...
                        <div class="team-member-data">
                            ...
                            <div class="team-member-desc">
                                <p>@lang('team.description_jeff')</p>
                            </div>
                ...
                <div class="col-xs-12 col-sm-3">
                    ...
                    <div class="team-member">
                        ...
                        <div class="team-member-data">
                            ...
                            <p>@lang('team.position_ervinas')</p>
                            <div class="handles">
                            ...
                            <div class="modal fade" role="dialog" id="ErvinasModal" tabindex="-1" aria-labelledby="gridModalLabel" style="display: none;">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="team-member-data">
                                                ...
                                                <div class="team-member-desc">
                                                    <p>@lang('team.description_ervinas')</p>
                                                </div>
                                            </div>
                ...
                <div class="col-xs-12 col-sm-3">
                    <div class="team-member">
                        ...
                        <div class="team-member-data">
                            ...
                            <p>@lang('team.position_danielius')</p>
                            <div class="handles">
                                <a href="https://www.linkedin.com/in/danius/" rel="nofollow" target="_blank"><i class="fa fa-linkedin-square" aria-hidden="true"></i></a>
                            </div>

                            <div class="modal fade" role="dialog" id="DanieliusModal" tabindex="-1" aria-labelledby="gridModalLabel" style="display: none;">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="team-member-data">
                                                ...
                                                <div class="team-member-desc">
                                                    <p>@lang('team.description_danielius')</p>
                                                </div>
                                            </div>
