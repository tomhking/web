<div class="contact-icons">
    <a class="contact-icon" href="https://twitter.com/bitdegree_org" rel="nofollow" target="_blank"><i class="fa fa-twitter" aria-hidden="true"></i></a>
    <a class="contact-icon" href="https://chat.bitdegree.org/" rel="nofollow" target="_blank"><i class="fa fa-slack" aria-hidden="true"></i></a>
