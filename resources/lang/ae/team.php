...
return array (
  'position_ceo' => 'شريك مؤسس، والرئيس التنفيذي',
  'position_cbo' => 'Co-founder, CBO',
  'position_cto' => 'CTO, Smart Contract Developer',
  'position_legal' => 'مستشار قانوني',
  'position_capital_investment' => 'Partner in Prime Block Capital Investment Fund',
  'position_cmo' => 'الرئيس التنفيذي للتسويق',
  'position_business_assistant' => 'مساعد الأعمال',
  'position_marketing_assistant' => 'مساعد التسويق',
  'position_designer' => 'مصمم المنتجات',
  'position_co_founder' => 'شريك مؤسس بصفة استشارية',
  'position_ceo_hostinger' => 'الرئيس التنفيذي - هوستنجر',
  'position_technical_advisor' => 'المستشار<br> التقني',
  ...
  'advisors' => 'المستشارون',
  'title' => 'الفريق',
  'subtitle' => 'دعنا نقدم لك الناس الرئيسيين الذين سوف يجعلون كل هذا ممكن.',
);
