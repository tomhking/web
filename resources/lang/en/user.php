...
return [
    ...
    'eth-wallet-note' => 'In order to receive the Tokens, make sure enter the address of the <b>same wallet that you are going to use to send ETH</b>.',
    'last-name' => 'Last name',
    'birthday' => 'Date of birth',
    'contribution' => 'I am planning to contribute:',
    'identity-verification' => 'Identity verification',
    'identity-submitted' => 'You have already submitted your identification.',
    'identity-verification-description' => 'For security reasons, contribution of 5 ETH or more should be followed by an upload of a clear picture of yourself holding your passport, driver’s license or national identity card with clear visibility of document’s photo of the person and written information.',
