...
return [
    ...
    'ico_section_description' => 'BitDegree token is a utility token. We are based in Lithuania, Europe, (LLC Company) and have an official confirmation from the Central Bank of Lithuania regarding the ICO..',
    ...
    'ico_point_law' => '100% compliant with law',
    'ico_point_transparent' => 'Transparency',
    'ico_point_description_opportunity' => 'The Token sale offers the same rules and opportunities for everyone. All discounts are public, there will be no hidden bonuses or secret deals.',
    'ico_point_description_transparent' => 'Smart Contract is open source and available for everyone on <a href="https://github.com/bitdegree/bitdegree-token-crowdsale/tree/master/contracts" rel="nofollow" target="_blank">Github</a>. There are no hidden rules or possibilities. The participants will receive their tokens instantly after payment.',
